 ...
 * SENG 300
   ...
   Description: This exception is thrown when the customer does not have enough funds to complete checkout
 */
public class InsufficientFundsException extends Exception{
	private static final long serialVersionUID = 7813659161550664284L;
